      ...
      return (
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Day Planner</h4>A simple calendar application that allows the
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Weather Dashboard</h4>A web app utilizing Open Weather API to
      ...
      return (
        <div className="projects-grid">
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Note Taker</h4>An application that can be used to write, save,
              and delete notes. This application will use an express backend and
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Eat Da Burger</h4>A burger logger with MySQL, Node, Express,
              Handlebars and a homemade ORM. Implemented MVC design pattern.
            </CardText>
            <CardActions border>
              <Button colored>
                {" "}
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Workout Tracker</h4>A web application that helps user track
              their workouts. Used Mongoose for ORM.
            </CardText>
            <CardActions border>
              <Button colored>
                {" "}
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Budget Tracker</h4>A Budget Tracker application that allows
              user to enter transactions for budgeting purposes. The application
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Employee Directory</h4>An employee directory that is made from
              React. Users should be able to filter and search for employees.
              Employee data is being pulled from Random User API.
            </CardText>
            <CardActions border>
              <Button colored>
                {" "}
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            <CardTitle
              style={{
                ...
                height: "176px",
                background:
                  "url(https://i.imgur.com/WZCWzqW.png) center / cover",
              }}
            ></CardTitle>
            <CardText>
              <h4>Corona Typer</h4>Corona Typer is a fast-paced typing game
              aimed at improving typing speed, skill, and accuracy.
            </CardText>
            <CardActions border>
              <Button colored>
                {" "}
      ...
      return (
        <div className="projects-grid">
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Github Profile Generator</h4>A command-line application that
              dynamically generates a PDF profile from a GitHub username.
              Details are being pulled from GitHub API
            </CardText>
            <CardActions border>
              <Button colored>
                {" "}
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              <h4>Team Roster Generator</h4>A Node CLI that takes in information
              about employees and generates an HTML webpage that displays
